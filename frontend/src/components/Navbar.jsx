import { LogOut, Briefcase, History, User, Sun, Moon, ShieldCheck } from 'lucide-react';

function Navbar({ onLogout, onToggleHistory, onEditProfile, onOpenSettings, darkMode, toggleDarkMode }) {
  return (
