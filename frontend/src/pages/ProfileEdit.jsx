    ...
    <div className="flex-1 flex flex-col overflow-hidden bg-slate-950">
      ...
      <header className="bg-slate-900 border-b border-slate-800 py-4 px-6 flex items-center justify-between flex-shrink-0 z-10 shadow-md">
        <div className="flex items-center gap-3">
          <button onClick={onBackToDashboard} className="p-2 text-slate-400 hover:text-slate-200 transition-colors bg-slate-950 border border-slate-800 hover:border-slate-700 rounded-xl">
        ...
        {activeTab === 'forms' && (
          <form onSubmit={handleSaveDirectForms} className="space-y-6">
            ...
            <div className="bg-slate-900/40 border border-slate-800 p-6 rounded-2xl space-y-6">
              <h2 className="text-sm font-extrabold uppercase tracking-wider text-primary-400 border-b border-slate-800 pb-2">Basic Credentials</h2>
              ...
              <div className="space-y-3 pt-4 border-t border-slate-800">
                ...
                {languages.map((lang, idx) => (
                  <div key={idx} className="flex items-center gap-3 animate-fade-in">
                    <input type="text" value={lang.language} onChange={(e) => handleLanguageChange(idx, 'language', e.target.value)} className="flex-1 py-2.5 px-4 bg-slate-950 border border-slate-800 rounded-xl text-slate-200 text-sm font-medium placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-transparent transition-all" placeholder="e.g. English" />
                    <select value={lang.level} onChange={(e) => handleLanguageChange(idx, 'level', e.target.value)} className="w-40 py-2.5 px-4 bg-slate-950 border border-slate-800 rounded-xl text-slate-400 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-transparent transition-all">
            ...
            <div className="bg-slate-900/40 border border-slate-800 p-6 rounded-2xl space-y-4">
              ...
              <div className="space-y-4">
                {educations.map((edu, idx) => (
                  <div key={idx} className="p-4 bg-slate-950 border border-slate-800 rounded-xl space-y-4 relative animate-fade-in">
                    {educations.length > 1 && (
            ...
            <div className="bg-slate-900/40 border border-slate-800 p-6 rounded-2xl space-y-6">
              ...
              <div className="space-y-4">
                <div className="space-y-1">
                  ...
                  <textarea value={experienceText} onChange={(e) => setExperienceText(e.target.value)} rows="5" className="w-full py-2.5 px-4 bg-slate-950 border border-slate-800 rounded-xl text-slate-200 text-sm font-medium placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-transparent transition-all" placeholder="Use format: Title | Company | Location | Duration\n- Bullet 1\n- Bullet 2"></textarea>
                </div>

                <div className="space-y-1">
                  <label className="text-xs font-bold text-slate-400">Skills</label>
                  <textarea value={skillsText} onChange={(e) => setSkillsText(e.target.value)} rows="3" className="w-full py-2.5 px-4 bg-slate-950 border border-slate-800 rounded-xl text-slate-200 text-sm font-medium placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-transparent transition-all" placeholder="List your technical stack separated by commas..."></textarea>
                </div>

                <div className="space-y-1">
                  <label className="text-xs font-bold text-slate-400">Projects</label>
                  <textarea value={projectsText} onChange={(e) => setProjectsText(e.target.value)} rows="5" className="w-full py-2.5 px-4 bg-slate-950 border border-slate-800 rounded-xl text-slate-200 text-sm font-medium placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-transparent transition-all" placeholder="Use format: Project Name | Type | Duration | Stack: Tech\n- Bullet 1\n- Bullet 2"></textarea>
                </div>

                <div className="space-y-1">
                  <label className="text-xs font-bold text-slate-400">Certifications</label>
                  <textarea value={certsText} onChange={(e) => setCertsText(e.target.value)} rows="3" className="w-full py-2.5 px-4 bg-slate-950 border border-slate-800 rounded-xl text-slate-200 text-sm font-medium placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-transparent transition-all" placeholder="E.g., Stanford Machine Learning | Coursera | Aug 2025"></textarea>
                </div>

                <div className="space-y-1">
                  <label className="text-xs font-bold text-slate-400">Volunteering & Activities</label>
                  <textarea value={volText} onChange={(e) => setVolText(e.target.value)} rows="3" className="w-full py-2.5 px-4 bg-slate-950 border border-slate-800 rounded-xl text-slate-200 text-sm font-medium placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-transparent transition-all" placeholder="Use format: Role | Organization | Duration\n- Bullet 1"></textarea>
                </div>

                <div className="space-y-1">
                  <label className="text-xs font-bold text-slate-400">Summary / Personal statement</label>
                  <textarea value={additionalText} onChange={(e) => setAdditionalText(e.target.value)} rows="3" className="w-full py-2.5 px-4 bg-slate-950 border border-slate-800 rounded-xl text-slate-200 text-sm font-medium placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-transparent transition-all" placeholder="Paste your short personal overview summary..."></textarea>
                </div>
              </div>
            </div>
